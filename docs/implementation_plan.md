...
| 10.9 | 掲示板未読管理UI | 未読数表示、一気読み、既読マーク | Phase 4, 10 | 未着手 |
...
**完了条件**:
- [ ] 掲示板画面に「未読一気読み [U]」オプションを追加
- [ ] 未読投稿を順番に表示、各投稿後に次へ進むプロンプト
- [ ] 一気読み中に中断可能（[Q]で終了）
- [ ] 表示した投稿を既読としてマーク
- [ ] 統合テスト
...
**完了条件**:
- [ ] スレッド表示時に表示した投稿を既読マーク
- [ ] フラット掲示板の投稿表示時に既読マーク
- [ ] ページ送りで新しい投稿を見た際も既読マーク
- [ ] 単体テスト
...
**完了条件**:
- [ ] 掲示板画面に「全て既読 [A]」オプションを追加
- [ ] 確認プロンプトを表示
- [ ] `mark_all_as_read()` を呼び出して実行
- [ ] ローカライズメッセージ追加
- [ ] 単体テスト
...
**完了条件**:
- [ ] 未読スレッド/投稿の先頭に `*` または `[N]` マークを表示
- [ ] スレッド形式：最後に読んだ投稿以降に新しい投稿があれば未読
- [ ] フラット形式：まだ読んでいない投稿は未読
- [ ] 単体テスト
